...
// Added functionality for countries
export const COUNTRY_DOMAIN = ["US","BR","JP","GB","TR","PH","AR","RU","ES","MX","Other"]
...
// Added functionality for countries
export const COUNTRY_COLORS = COUNTRY_DOMAIN.map((country, i) => COLORS[i % COLORS.length])
export const COUNTRY_COLOR_MAP = COUNTRY_DOMAIN.reduce((acc, country, i) => ({
  ...acc,
  [country]: COLORS[i % COLORS.length]
}), {})
